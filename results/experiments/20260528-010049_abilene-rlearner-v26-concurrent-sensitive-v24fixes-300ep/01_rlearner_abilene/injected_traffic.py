...
os.environ['TRAFFIC_OUTPUT'] = '/home/johndoe/Desktop/sdn-rl-routing/results/experiments/20260528-010049_abilene-rlearner-v26-concurrent-sensitive-v24fixes-300ep/01_rlearner_abilene/traffic.csv'
os.environ['TRAFFIC_DONE'] = '/home/johndoe/Desktop/sdn-rl-routing/results/experiments/20260528-010049_abilene-rlearner-v26-concurrent-sensitive-v24fixes-300ep/01_rlearner_abilene/traffic.csv.done'
...
os.environ['TRAFFIC_CONCURRENT_START_SPREAD'] = '0.5'
os.environ['TRAFFIC_SEED'] = '1'
os.environ['TRAFFIC_FEEDBACK_PORT'] = '10026'
try:
	__import__('traffic.generate_traffic', fromlist=['run_from_env']).run_from_env(net)
except BaseException:
	with open('/home/johndoe/Desktop/sdn-rl-routing/results/experiments/20260528-010049_abilene-rlearner-v26-concurrent-sensitive-v24fixes-300ep/01_rlearner_abilene/traffic.csv.partial', 'w') as handle:
